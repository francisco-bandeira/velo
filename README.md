...
```env
VITE_SUPABASE_PROJECT_ID="bpmausmyofonugyclfie"
VITE_SUPABASE_PUBLISHABLE_KEY="sb_publishable_ZM_g7OT5ZtMeAiB6N4qZKg_lox8f4qr"
VITE_SUPABASE_URL="https://bpmausmyofonugyclfie.supabase.co"
```
